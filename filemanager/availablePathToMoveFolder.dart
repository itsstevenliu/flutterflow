...
List<String> availablePathToMoveFolder(
  ...
  // Remove outputs starting with currentParentPath + currentFolderName
  uniqueCombinedList.removeWhere(
      (output) => output.startsWith('$currentParentPath${fileTitle}'));
